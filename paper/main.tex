...
%TC:ignore
\begin{titlepage}
{\noindent\LARGE\bf Fully Bayesian Uncertainty-Aware Biomarkers for Image-Based Cancer Diagnosis: Application to Prostate Diffusion MRI}

\bigskip

\begin{flushleft}\large
    Patrick Remerscheid\textsuperscript{1,{*}},
...
\item Independent Researcher, Switzerland
