...
(2000 resamples) \citep{efron1993bootstrap}; equivalence is read from
overlapping intervals.
% NOTE(Patrick): you asked about adding the individual single-fraction AUCs
% (the thin curves in Fig 2) here "for reference." They are raw, in-sample,
% max-orientation AUCs (not in auc_table.csv; computed in fig2_roc_detection.py)
% and 8 bins x 2 zones would crowd the main table -- recommend a Supporting
% Information table instead. Decide before submission.
