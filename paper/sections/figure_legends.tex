...
CRLB under a Gaussian approximation of the half-normal prior with scale
$\sigma_R = 3.16$ (dark gray), and the empirical NUTS posterior standard
deviation (orange), the last sampled under the true half-normal prior with
non-negativity.
Annotated factors give the prior gain (gray, unconstrained\,$\to$\,Bayesian) and
the constraint gain (orange, Bayesian\,$\to$\,NUTS, up to $74\times$).
