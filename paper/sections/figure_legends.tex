...
peak than MAP.
The bottom row reports NUTS noise recovery for each ground truth (A--F): the
jointly inferred $\hat{\sigma}$ (posterior mean) tracks the true
$\sigma = 1/\mathrm{SNR}$ (dashed) across SNR, validating the joint inference of
