...
The interval is on average $2.4\times$ wider for misclassified than correctly
classified ROIs (pooled mean width $0.39$ vs $0.16$; Welch $p = 0.003$), and
also widens toward the decision boundary---partly a geometric property of the
logistic link (the boundary effect shrinks markedly in logit space) but with a
genuine residual.
The few confidently-misclassified ROIs are almost all low-grade or ungraded
tumors whose spectra resemble normal tissue
(cf.\ Figure~\ref{fig:spectrum_ggg})---a contrast limit, not a failure of the
uncertainty estimate. This analysis is exploratory.
}
