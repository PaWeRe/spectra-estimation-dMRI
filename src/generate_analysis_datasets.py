...
if __name__ == "__main__":
    json_file = os.path.join(DATA_DIR_PATH + "/processed_patient_dict.json")
    csv_file = os.path.join(DATA_DIR_PATH + "/prostate_rois.csv")
    gleason_file = os.path.join(DATA_DIR_PATH + "/patient_gleason_grading.csv")
    d1_file = os.path.join(DATA_DIR_PATH + "/tumor_normal_d1.json")
    d1_file_discarded = os.path.join(DATA_DIR_PATH + "/tumor_normal_d1_discarded.json")
    d2_file = os.path.join(DATA_DIR_PATH + "/ggg_aggressiveness_d2.json")
    d2_file_discarded = os.path.join(
        DATA_DIR_PATH + "/ggg_aggressiveness_d2_discarded.json"
    )
