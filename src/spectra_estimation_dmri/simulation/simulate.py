...
def generate_simulated_signal(snr, diff_values, b_values, true_spectrum):
    """
    Generate simulated diffusion MRI signal with Gaussian noise.
    ...
    Returns:
        signals: Simulated noisy signal (np.ndarray, shape [n_bvals,])
    """
    s0 = 1.0
